<template>
    <div class="club-activity">
        <div class="filter-container">
            ...
            <el-input style="width: inherit" v-model="listQuery.title" placeholder="请输入标题"></el-input>
        ...
        <el-table
                ...
                style="width: 100%;"
        >
            <el-table-column label="百科标题" align="center">
            ...
            <el-table-column label="浏览量" align="center">
                <template slot-scope="{ row }">
                    <span>{{ row.infoVisit }}</span>
                </template>
            </el-table-column>
            <el-table-column label="详情" align="center">
                <template slot-scope="{ row }">
                    <el-button type="success" plain @click="showDetailPage(row.infoDetail)">查看详情页</el-button>
                </template>
            </el-table-column>
        ...
        <el-dialog :title="handleType" :visible.sync="dialogFormVisible" @close="closeDialog()">
            ...
            >
                ...
                <el-form-item label="标题">
                    <el-input style="width:100%" v-model="temp.infoTitle"></el-input>
                </el-form-item>
                <el-form-item label="浏览量">
                    <el-input style="width:100%" v-model="temp.infoVisit"></el-input>
                </el-form-item>
                <el-form-item label="详情">
                    <textarea style="width:100%" v-model="temp.infoDetail"></textarea>
                </el-form-item>
            </el-form>
...
<script>
    ...
    import { findAll, addMessage, updateMessage, deleteMessage, ableInfo, disableInfo } from '../../../../api/info';
    ...
    export default {
        ...
        methods: {
            ...
            async ableAndDisable(row) {
                ...
                if (state) {
                    const res = ableInfo(row.id);
                } else {
                    const res = disableInfo(row.id);
                }
            ...
            //插入
            async insert() {
                const res = await addMessage(this.temp);
                if (res.code === 10000) {
                    this.$message({
                        type: 'info',
                        message: '操作成功'
